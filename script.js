...
function fillShape(id) {
    if (!fields[id] && !gameOver) {    // wenn "nicht gameover" (!gameOver)
        if (currentShape == 'cross') {
            currentShape = 'circle';
            document.getElementById('player-1').classList.remove('player-inactiv');
            document.getElementById('player-1').classList.add('player-activ');
            document.getElementById('player-2').classList.remove('player-activ');
            ...
            document.getElementById('player-2').classList.add('player-activ');
            document.getElementById('player-1').classList.remove('player-activ');
